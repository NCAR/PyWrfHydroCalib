...
def main(argv):
    ...
    for job in range(0,numJobs):
        ...
        print("Job Run Type: " + str(results[job][30]))
        print("Executable Path: " + str(results[job][31]))
        print("Number of Gages: " + str(results[job][32]))
        print("Owner: " + str(results[job][33]))
        print("Email: " + str(results[job][34]))
