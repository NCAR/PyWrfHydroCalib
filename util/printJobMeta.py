...
def main(argv):
    ...
    for job in range(0,numJobs):
        ...
        print "SQL Host: " + str(results[job][31])
        print "Job Run Type: " + str(results[job][32])
        print "Executable Path: " + str(results[job][33])
        print "Number of Gages: " + str(results[job][34])
        print "Owner: " + str(results[job][35])
        print "Email: " + str(results[job][36])
        print "Slack Channel: " + str(results[job][37])
        print "Slack Token: " + str(results[job][38])
        print "Slack User: " + str(results[job][39])
        print "Analysis Run Type: " + str(results[job][40])
        print "Analysis Que Name: " + str(results[job][41])
        print "--------------------------------------------------"
